  ...
  return (
    <form onSubmit={handleSubmit} role="search" className="relative">
      ...
      <button
        type="submit"
        aria-label={label}
        className="absolute end-2 top-1/2 flex size-10 -translate-y-1/2 items-center justify-center rounded-xl text-muted-foreground transition-colors hover:bg-tint hover:text-tint-foreground"
      >
