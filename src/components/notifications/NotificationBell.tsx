  ...
  return (
    <Popover open={open} onOpenChange={setOpen}>
      <div className="relative inline-flex">
        <PopoverTrigger render={<Button variant="ghost" size="icon" aria-label={t("label")} className={className} />}>
          <Bell aria-hidden="true" className="size-5" />
        </PopoverTrigger>
        {unreadCount > 0 && (
          <Badge
            variant="destructive"
            className="pointer-events-none absolute -top-1 -right-1 h-4 min-w-4 justify-center rounded-full px-1 text-[10px]"
          >
